...
function AiChat() {
  ...
  return (
    <div className="section flex justify-center px-4 py-6 min-h-[60vh] w-full sm:w-11/12 mt-6 rounded-2xl">
      <div className="Card bg-white w-full flex flex-col shadow-lg rounded-2xl overflow-hidden">
        {/* Header */}
        <div className="chat-header text-white px-6 py-4">
          <h2 className="text-xl font-semibold">Ask Computer Ji</h2>
          <p className="text-sm opacity-80">
            Ask your Computer Ji, how your farm is doing?
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="border-t border-gray-200 p-4 bg-white">
          <div className="flex space-x-2">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`gradient-button text-white px-4 py-2 rounded-lg transition-all duration-300
